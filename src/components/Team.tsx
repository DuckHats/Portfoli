      ...
      <div className="max-w-5xl mx-auto px-4 text-center">
        ...
        opacity
          ...
          boxShadow: `10px 10px 0px 0px ${brandConfig.colors.primary.black}`
            ...
            <div aria-hidden="true" className="absolute -top-4 -left-4 text-4xl" style={{
            color: brandConfig.colors.accent.red
          }}>
              ↙
            </div>
            <div aria-hidden="true" className="absolute -top-4 -right-4 text-4xl" style={{
            color: brandConfig.colors.accent.red
          }}>
              ↘
            </div>
            <div aria-hidden="true" className="absolute -bottom-4 -left-4 text-4xl" style={{
            color: brandConfig.colors.accent.red
          }}>
              ↖
            </div>
            <div aria-hidden="true" className="absolute -bottom-4 -right-4 text-4xl" style={{
            color: brandConfig.colors.accent.red
          }}>
              ↗
            </div>
        ...
        once: true
      }} className="max-w-4xl mx-auto text-lg" style={{
        color: brandConfig.colors.neutral.gray700
      }}>
          <span className="text-xl text-gray-600 leading-relaxed" style={{
        }}>
            {content.team.planText}
          </span>
        </motion.div>
      </div>
    </section>;

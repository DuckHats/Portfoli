  ...
  ca: {
    ...
    joinUs: {
      ...
      form: {
        ...
        otherRolePlaceholder: 'Especifica quin rol...',
  ...
  es: {
    ...
    joinUs: {
      ...
      form: {
        ...
        otherRolePlaceholder: 'Especifica qué rol...',
  ...
  en: {
    ...
    about: {
      ...
      hats: {
        ...
        description: 'Why "Hats"? Because in the digital world, adaptability is survival. One day we\'re UI designers, the next back-end architects, and sometimes we\'re just therapists for your brand identity crisis.'
      }
    },
    team: {
      title: 'THE FLOCK',
    ...
    joinUs: {
      ...
      form: {
        ...
        otherRolePlaceholder: 'Specify which role...',

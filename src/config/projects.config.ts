...
export const projectsData: Project[] = [
  {
    ...
    gallery: [
      '/projects/menuGinebro/menu-ginebro-01.png',
      '/projects/menuGinebro/menu-ginebro-02.png',
      '/projects/menuGinebro/menu-ginebro-03.png',
      '/projects/menuGinebro/menu-ginebro-04.png',
      '/projects/menuGinebro/menu-ginebro-05.png',
      '/projects/menuGinebro/menu-ginebro-06.png',
      '/projects/menuGinebro/menu-ginebro-07.png',
      '/projects/menuGinebro/menu-ginebro-08.png',
      '/projects/menuGinebro/menu-ginebro-09.png',
      '/projects/menuGinebro/menu-ginebro-10.png',
      '/projects/menuGinebro/menu-ginebro-11.png',
      '/projects/menuGinebro/menu-ginebro-12.png',
    ],
    link: '',
